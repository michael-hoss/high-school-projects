...
Partial Friend Class Bastard
	...
	Private Sub Form_Resize(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Resize
		...
		lblLevel.Left = (imgLeben(3).Left + imgLeben(3).Width + cmdNeuesSpiel.Left - lblLevel.Width) / 2
		...
		imgBonusleben.Top = linUnten.getY1() / 15 - imgBonusleben.Height - 2 * imgA.Height
