...
namespace UpgradeHelpers.Gui.Utils
{
    /// <summary>
    ...
    public class FormHelper
    {
        ...
        private class PrintFormClass : IDisposable
        {
            ...
            public void Print(Form frm)
            {
                ...
                DrawIntoForm(frm);
                SetDefaultVB6DialogTitle(frm);
                printDocument1.Print();
            }

            private void SetDefaultVB6DialogTitle(Form frm)
            {
                var field = printDocument1.PrintController.GetType().GetField("dialogTitle", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic);
                if (field != null)
                {
                    var appTitle = Helpers.AssemblyHelper.GetTitle(frm.GetType().Assembly);
                    field.SetValue(printDocument1.PrintController, appTitle);
                }
            }
            ...
            private void DrawIntoForm(Form frm)
            {
